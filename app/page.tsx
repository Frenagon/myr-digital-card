...
export default function Home() {
  return (
    <div className="flex h-screen min-h-[800px] w-screen items-center justify-center">
      <div className="flex h-full w-full flex-col overflow-hidden bg-primary-200 md:aspect-9/16 md:h-7/8 md:w-auto md:rounded-2xl md:shadow-[0_35px_50px_rgba(0,0,0,0.25)]">
